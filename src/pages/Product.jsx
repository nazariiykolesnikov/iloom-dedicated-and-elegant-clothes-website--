...
const Product = () => {
    const breadcrumbItems = [
        { label: 'Главная', to: '/' },
        { label: 'Женщинам', to: '/clothes-for-woman' },
        { label: 'Одежда для женщин', to: '/clothes-for-woman' },
        { label: 'Женские штаны', to: '/clothes-for-woman/pants' },
        { label: 'Джинсы' }
    ];
    ...
    return (
        ...
        <header className="relative">
            <div className="header relative ml-[-115px] mt-[-300px]">
                ...
                {menuOpen && (
                    <div
                        className="absolute top-[93px] left-[100px] w-[288px] h-[715px] bg-gradient-to-br from-[#fc8bd1] to-[#fdb1e2] rounded-[30px] flex flex-col items-center py-6 z-50 shadow-[0_8px_25px_rgba(0,0,0,0.25)] backdrop-blur-md animate-fade-in">
                        <nav
                            className="flex flex-col gap-3 text-white text-[17px] font-semibold w-full px-6 mt-[10px] ml-[15px]">
                    ...
                    <button
                        ...
                        <div className="flex items-center gap-[8px]">
                            ...
                            <div className="flex flex-col leading-[16px] font-medium">
                                ...
                                <span
                                    className="montserrat text-[12px] font-[600] text-[#ffffff]">Алматы, Казахстан</span>
                            </div>
                        </div>
                        <img
